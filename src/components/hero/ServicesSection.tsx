      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 max-w-7xl mx-auto">
        ...
        <div className="mb-12 sm:mb-16">
          ...
          <div className="max-w-4xl">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-normal text-gray-900 mb-4 sm:mb-6 leading-tight">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-16 sm:mb-20">
          {mainServices.map((service, index) => {
            ...
            return (
              <div 
                key={index} 
                className="group relative bg-gray-100 border border-gray-200 p-6 sm:p-8 hover:border-blue-200 hover:shadow-lg transition-all duration-300"
              >
                {/* Subtle gradient background */}
                <div className="absolute inset-0 bg-gradient-to-br from-blue-50/30 to-transparent rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                
                <div className="relative z-10">
                  <div className="mb-6">
                    <div className="w-12 h-12 bg-blue-50 rounded-sm flex items-center justify-center group-hover:bg-blue-100 transition-colors duration-200">
                      <IconComponent className="w-6 h-6 text-blue-600 group-hover:text-blue-700 transition-colors duration-200" />
                    </div>
                  </div>
                  <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 sm:mb-4 group-hover:text-gray-800  transition-colors">
                    {service.title}
                  </h3>
                  ...
                  <div className="absolute bottom-0 left-6 sm:left-8 right-6 sm:right-8 h-0.5 bg-gradient-to-r from-blue-500 to-blue-300 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                </div>
              </div>
            );
          })}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="space-y-6 sm:space-y-8">
              <div>
                <div className="inline-flex items-center px-3 py-1 rounded-full bg-blue-500 text-white text-sm font-medium mb-4 sm:mb-6">
                ...
                <p className="text-lg sm:text-xl text-gray-300 font-light leading-relaxed mb-6 sm:mb-8">
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm sm:text-base text-gray-300">Enterprise-grade architecture</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-blue-400 rounded-full"></div>
                  <span className="text-sm sm:text-base text-gray-300">Scalable and maintainable code</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-blue-400 rounded-full"></div>
                  <span className="text-sm sm:text-base text-gray-300">Modern development practices</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-blue-400 rounded-full"></div>
                  <span className="text-sm sm:text-base text-gray-300">Continuous integration & deployment</span>
                </div>
              </div>
                  ...
                  >
                    <div className="relative h-full w-full overflow-hidden bg-white shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
                      <div className="h-full p-4 sm:p-6 flex flex-col justify-between">
                        <div>
                          <div className="w-8 h-8 sm:w-10 sm:h-10 bg-blue-50 rounded-sm flex items-center justify-center mb-3 sm:mb-4">
                        ...
                        <button className="self-start px-3 sm:px-4 py-2 bg-blue-500 text-white font-medium hover:bg-blue-600 transition-colors text-xs sm:text-sm mt-4">
                          Learn More
                        </button>
                      </div>
                    </div>
